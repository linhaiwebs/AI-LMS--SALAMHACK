...
export default function FAQPage() {
  const faqs = [
    {
      q: "金脳はどんなサービスですか？",
      a: "金脳は、AIを活用した株式投資教育プラットフォームです。パーソナライズされた学習コース、市場分析の基礎知識、リスクシミュレーションなどを提供し、初心者から上級者まで投資スキルの向上をサポートします。",
    },
    {
      q: "投資の初心者でも利用できますか？",
    ...
    {
      q: "無料プランでも利用できますか？",
      a: "はい、フリープランでは基本コース3本まで受講でき、AI学習アシスタントもご利用いただけます。さらに多くの機能をご利用になりたい場合は、プロプランへのアップグレードが可能です。",
    },
    {
